...
$subject = 'Solicitud de recuperacion de contrasena - Admin Panel';
...
$htmlBody .= '<div style="text-align:center;margin-bottom:24px"><h2 style="color:#1e293b;margin:0">Recuperacion de Contrasena</h2></div>';
$htmlBody .= '<p style="color:#475569;font-size:15px;line-height:1.6">Se ha solicitado una recuperacion de contrasena desde el <strong>Admin Panel</strong> de Imporlan.</p>';
...
$htmlBody .= '<p style="color:#94a3b8;font-size:12px;text-align:center">Notificacion automatica del sistema Imporlan</p>';
