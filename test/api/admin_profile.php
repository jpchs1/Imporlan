...
require_once $rootDir . '/api/auth_helper.php';
$profileDir = $rootDir . '/.admin_profiles';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strpos($contentType, 'multipart/form-data') !== false) {
        ...
        if ($action === 'update_photo' && isset($_FILES['avatar'])) {
            ...
            $profiles[$userEmail]['avatar_url'] = '/test/api/admin_avatar.php?u=' . urlencode($userEmail) . '&t=' . time();
    ...
    if ($action === 'change_password') {
        ...
        $proxyFile = $rootDir . '/api/test/proxy.php';
        $adminApiFile = $rootDir . '/api/admin_api.php';
