...
(function () {
  ...
  function buildFooter() {
    ...
    var html = ''
      ...
      + '<section class="imp-wrap" aria-label="Cotizar importacion de lancha">'
      + '  <div class="imp-cta-strip">'
      + '    <div class="imp-cta-inner">'
      + '      <div class="imp-cta-text">'
      + '        <span class="imp-cta-pill"><span class="imp-dot"></span>Cotizacion gratis</span>'
      + '        <h2>¿Listo para encontrar tu lancha?</h2>'
      + '        <p>Pegá los links de las lanchas que te interesan y te entregamos el costo final puerta a puerta en 48-72 horas hábiles.</p>'
      + '      </div>'
      + '      <div class="imp-cta-actions">'
      + '        <a href="/cotizador-importacion/" class="imp-btn imp-btn-primary">'
      ...
      + '          <span><span class="imp-contact-label">WhatsApp</span><span class="imp-contact-value">+56 9 4021 1459</span><span class="imp-contact-sub">Lun-Vie 09-19 · Sáb-Dom 10-19</span></span>'
      + '        </a>'
