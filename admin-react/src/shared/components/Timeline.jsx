const STEPS = [
  { num: 1, label: 'Plan o Cotización', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  { num: 2, label: 'Búsqueda Activa', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
  { num: 3, label: 'Inspección', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
  ...
  { num: 5, label: 'Logística', icon: 'M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0' },
];
...
export default function Timeline({ step = 1, onPrev, onNext }) {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-2xl overflow-hidden shadow-lg mb-5">
      ...
      {/* Los pasos tienen ancho fijo, asi que en un telefono no caben los cinco:
          sin este scroll horizontal el ultimo queda cortado contra el borde. */}
      <div className="px-4 pb-3 flex items-start justify-start sm:justify-center gap-0 overflow-x-auto">
        {STEPS.map((s, i) => {
      ...
      {/* Solo el admin mueve el expediente de paso. El panel del cliente monta
          este mismo componente sin onPrev/onNext, y hasta ahora igual pintaba
          los dos botones: el cliente veia un "Avanzar" en primario que no hacia
          absolutamente nada al apretarlo. */}
      {(onPrev || onNext) && (
