...
(function() {
    ...
    function applyMobileLayout() {
        const modalContent = chatModal.querySelector('#user-chat-modal-content');
        const convPanel = chatModal.querySelector('.user-chat-conversations-panel');
        const modalBody = chatModal.querySelector('.user-chat-modal-body');
        const header = chatModal.querySelector('#user-chat-modal-header');
        const resizeHandles = chatModal.querySelectorAll('.user-resize-handle');
        if (modalContent) {
            modalContent.style.cssText = 'position: fixed !important; top: 0 !important; left: 0 !important; right: 0 !important; bottom: 0 !important; width: 100% !important; height: 100% !important; max-width: 100% !important; max-height: 100% !important; min-width: 0 !important; min-height: 0 !important; background: #ffffff !important; border-radius: 0 !important; overflow: hidden !important; display: flex !important; flex-direction: column !important; box-shadow: none !important;';
        }
        if (modalBody) {
            modalBody.style.cssText = 'flex: 1 !important; display: flex !important; flex-direction: column !important; overflow: hidden !important; min-height: 0 !important;';
        }
        if (convPanel) {
            convPanel.style.cssText = 'width: 100% !important; min-width: 0 !important; max-width: 100% !important; max-height: 35vh !important; border-right: none !important; border-bottom: 1px solid #e2e8f0 !important; display: flex !important; flex-direction: column !important; background: #ffffff !important; flex-shrink: 0 !important; overflow-y: auto !important;';
        }
        if (header) {
    ...
    function applyDesktopLayout() {
        ...
        const resizeHandles = chatModal.querySelectorAll('.user-resize-handle');
        if (modalContent) {
            modalContent.style.cssText = 'position: absolute !important; width: 800px !important; height: 550px !important; min-width: 450px !important; min-height: 350px !important; max-width: none !important; max-height: none !important; background: #ffffff !important; border-radius: 16px !important; overflow: visible !important; display: flex !important; flex-direction: column !important; box-shadow: 0 20px 60px rgba(10, 22, 40, 0.3) !important;';
            const width = modalContent.offsetWidth || 800;
            const height = modalContent.offsetHeight || 550;
            modalContent.style.left = `${Math.max(0, (window.innerWidth - width) / 2)}px`;
            modalContent.style.top = `${Math.max(0, (window.innerHeight - height) / 2)}px`;
        ...
        if (modalBody) {
            modalBody.style.cssText = 'flex: 1 !important; display: flex !important; overflow: hidden !important; min-height: 0 !important;';
        }
        if (convPanel) {
            convPanel.style.cssText = 'width: 300px !important; min-width: 250px !important; max-width: 300px !important; border-right: 1px solid #e2e8f0 !important; display: flex !important; flex-direction: column !important; background: #ffffff !important; flex-shrink: 0 !important;';
        }
        if (header) {
