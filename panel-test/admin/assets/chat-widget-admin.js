...
(function() {
    ...
    function openChatModal() {
        ...
        // Center the modal after it's visible (skip on mobile - fullscreen)
        if (!isMobile()) {
    ...
    function createChatModal() {
        ...
        chatModal.innerHTML = `
            <div class="admin-chat-modal-content" id="chat-modal-content" style="position: ${mobile ? 'fixed' : 'absolute'} !important; ${mobile ? 'top:0!important;left:0!important;right:0!important;bottom:0!important;width:100%!important;height:100%!important;min-width:0!important;min-height:0!important;max-width:100%!important;max-height:100%!important;border-radius:0!important;' : 'width:900px!important;height:600px!important;min-width:500px!important;min-height:400px!important;max-width:none!important;max-height:none!important;border-radius:16px!important;'} background: #ffffff !important; overflow: visible !important; display: flex !important; flex-direction: column !important; box-shadow: 0 20px 60px rgba(10, 22, 40, 0.3) !important;">
                <div class="admin-chat-modal-header" id="chat-modal-header" style="padding: 16px 20px !important; background: linear-gradient(135deg, #0a1628 0%, #1a365d 100%) !important; display: flex !important; align-items: center !important; justify-content: space-between !important; cursor: ${mobile ? 'default' : 'move'} !important; user-select: none !important; flex-shrink: 0 !important; border-radius: ${mobile ? '0' : '16px 16px 0 0'} !important;">
                ...
                <div class="admin-chat-modal-body" style="flex: 1 !important; display: flex !important; overflow: hidden !important; min-height: 0 !important;">
                    <div class="admin-chat-conversations-panel" style="${mobile ? 'width:100%!important;min-width:0!important;max-width:100%!important;' : 'width:350px!important;min-width:280px!important;max-width:350px!important;'} border-right: 1px solid #e2e8f0 !important; display: flex !important; flex-direction: column !important; background: #ffffff !important; flex-shrink: 0 !important;">
                ...
                ${mobile ? '' : `<div class="admin-resize-handle admin-resize-handle-e" style="position: absolute !important; right: -4px !important; top: 60px !important; bottom: 20px !important; width: 8px !important; cursor: ew-resize !important; background: transparent !important; z-index: 10 !important;"></div>
        ...
        // Center the modal initially (skip on mobile - fullscreen)
        const centerModal = () => {
            if (isMobile()) return;
