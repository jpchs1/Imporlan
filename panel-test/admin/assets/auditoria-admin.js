(function () {
  ...
  function init() {
    new MutationObserver(checkAuditSection).observe(document.body, { childList: true, subtree: true });
    setTimeout(checkAuditSection, 1000);
    setTimeout(checkAuditSection, 3000);
  }
