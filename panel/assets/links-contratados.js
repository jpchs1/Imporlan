...
(function () {
  ...
  function showInspectionModal(linkUrl, linkIdx) {
    ...
    overlay.innerHTML =
      ...
      '<div style="background:linear-gradient(135deg,#f0f9ff,#e0f2fe);border-radius:12px;padding:16px;text-align:center"><p style="margin:0;font-size:11px;color:#0369a1;text-transform:uppercase;font-weight:600;letter-spacing:.05em">Menor a 25 FT</p><p style="margin:6px 0 0;font-size:24px;font-weight:800;color:#0891b2">USD $850</p></div>' +
      '<div style="background:linear-gradient(135deg,#eff6ff,#dbeafe);border-radius:12px;padding:16px;text-align:center"><p style="margin:0;font-size:11px;color:#1d4ed8;text-transform:uppercase;font-weight:600;letter-spacing:.05em">26 a 30 FT</p><p style="margin:6px 0 0;font-size:24px;font-weight:800;color:#2563eb">USD $1.200</p></div>' +
      '<div style="background:linear-gradient(135deg,#eef2ff,#e0e7ff);border-radius:12px;padding:16px;text-align:center"><p style="margin:0;font-size:11px;color:#4338ca;text-transform:uppercase;font-weight:600;letter-spacing:.05em">Mayor a 31 FT</p><p style="margin:6px 0 0;font-size:24px;font-weight:800;color:#4f46e5">USD $1.800</p></div></div></div>' +
